...
def main(format):
    ...
    try:
        genotype = Genotype(down=[('dep_sep_conv_3', 1), ('conv_1', 0), ('dil_3_conv_5', 1), ('conv_1', 0)], down_concat=range(2, 4), up=[('dep_sep_conv_3', 0), ('conv_1', 1), ('identity', 0), ('avg_pool', 2)], up_concat=range(2, 4), gamma=[1, 0, 0, 1, 1, 1])
