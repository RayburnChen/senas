...
from models.nasunet.geno_searched import NASUNET
from models.nasunet.prim_ops_set import *
...
class NasUnet(nn.Module):
    ...
    def __init__(self, nclass, in_channels, c=32, depth=5, dropout_prob=0, double_down_channel=False):
